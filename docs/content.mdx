...
`const home = {
    label: "Home",
    title: "Jamie Nisbet's Portfolio",
    description: "Portfolio website showcasing my work as a Full Stack Software Engineer",
    headline: <>Building AI-driven solutions that transform businesses</>,
    subline: (
      <>

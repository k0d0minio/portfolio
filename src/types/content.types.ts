...
export interface Home extends BasePageConfig {
   ...
   */
  image: `/images/${string}` | string;
  /** The headline of the home page (can be a single value or array for rotation) */
  ...
  /** The sub text which appears below the headline (can be a single value or array for rotation) */
  subline: React.ReactNode | React.ReactNode[];
}
